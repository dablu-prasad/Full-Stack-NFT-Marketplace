...
function Instruction() {
    return (
        <div className='cards'>
            <h1> Instruction to Create and sell your NFTs!</h1>
            <div className='cards__container'>
                <div className='cards__wrapper'>
                    <ul className='cards__items'>
                        <CardItem
                            src='https://thedefiant.io/wp-content/webpc-passthru.php?src=https://thedefiant.io/wp-content/uploads/2022/03/MaskToken.jpg&nocache=1'
